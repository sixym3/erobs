...
class SimpleClient(Node):
    ...
    def __init__(self):
        ...
        self._action_client = ActionClient(
            self, FidPoseControlMsg, "pdf_beamtime_fidpose_action_server"
        )
    ...
    def send_pickup_goal(self, sample_id):
        ...
        goal_msg.inbeam_approach = [
            x / 180 * math.pi for x in [55.10, -51.78, 124.84, -73.16, 52.24, 180.0]
        ]
        goal_msg.inbeam = [
            x / 180 * math.pi for x in [63.84, -47.71, 98.22, -50.59, 61.00, 180.0]
        ]
