...
def generate_launch_description():
    ## Arguments  
    ## mock_hardware is for pipette sim, currently can only be setup through the xacro file, launch file arg doesn't work
    ...
    # Pipette controller spawners
    plunger_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["plunger_controller", "-c", "/controller_manager"],
    )

    tip_eject_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["tip_eject_controller", "-c", "/controller_manager"],
    )
    ...
    return LaunchDescription([
        ...
        plunger_controller_spawner,
        tip_eject_controller_spawner,
    ])
